...
print(f'Training 3B | {config.max_steps} steps | batch=2 | grad_accum=4 | beta=0.1')
...
# ========== CELL 11: Merge & Upload (UNCOMMENT + ADD TOKEN) ==========
...
# print("✅ Model + evidence uploaded to https://huggingface.co/degree-checker-01/edupath-grpo-tutor")
